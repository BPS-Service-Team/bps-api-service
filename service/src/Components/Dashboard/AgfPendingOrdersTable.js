...
import { useFetchAgfOrders } from '../../Hooks/AgfPendingOrders.hook';
const AgfPendingOrdersTable = () => {
  const [orders, loading, , update] = useFetchAgfOrders();
  const columns = [
    {
      title: 'Order No.',
      dataIndex: 'order_id',
...
export default AgfPendingOrdersTable;
